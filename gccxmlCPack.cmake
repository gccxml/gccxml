...
FILE(STRINGS "VERSION"  GCCXML_VERSION_FULL)
STRING(REGEX REPLACE "^([0-9]*)\\..*"                   "\\1"   GCCXML_VERSION_MAJOR "${GCCXML_VERSION_FULL}")
STRING(REGEX REPLACE "^([0-9]*)\\.([0-9]*)\\."          "\\2"   GCCXML_VERSION_MINOR "${GCCXML_VERSION_FULL}")
STRING(REGEX REPLACE                     "\\.([0-9]*)$" "\\1"   GCCXML_VERSION_PATCH "${GCCXML_VERSION_FULL}")
